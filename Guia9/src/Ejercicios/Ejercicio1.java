 ...
 * 
   ...
   y su longitud. Agregar constructor vacío y con atributo frase solamente. Agregar getters y setters. El constructor
...
public class Ejercicio1 {
    ...
    public static void main(String[] args) {
        ...
        CadenaServicios cadServ = new CadenaServicios();
        
        Cadena frase1 = cadServ.crearCadena();
        System.out.println("La frase contiene la cantidad de "+cadServ.mostrarVocales(frase1)+" vocales.");
        cadServ.invertirFrase(frase1);
        cadServ.vecesRepetido(frase1);
        cadServ.comparaLongitud(frase1);
        cadServ.unirFrases(frase1);
        cadServ.reemplazar(frase1);
        cadServ.contiene(frase1);
